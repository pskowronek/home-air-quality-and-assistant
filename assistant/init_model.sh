...
echo "and upload keyphrase.list file. After that you need to download generated TGZ and extract it into"
echo "model folder. Afterwards you need to remember to update config.yaml to reflect correct names for 'lm' and 'dic'."
